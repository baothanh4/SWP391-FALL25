...
public class VNPayService {
    public String createVNPayUrl(String orderID, long amount) throws UnsupportedEncodingException, NoSuchAlgorithmException, InvalidKeyException {
...
//    Orders order = createOrder(orderRequest);
        ...
        String tmnCode = "DWCBEY9Q";
        String secretKey = "GNPMXK160WDIPNTPV5D5AZ29BLXTHDP7";
...
//    vnpParams.put("vnp_ReturnUrl", returnUrl);
        vnpParams.put("vnp_ReturnUrl", "http://localhost:5173/payment-return?paymentID=" + orderID);
